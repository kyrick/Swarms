...
public class ImageSFXs {
	 ...
	 */
	public void drawFadedResizedImage(Graphics2D g2d, BufferedImage im, int x, int y, int scale,
			float alpha) {
		
		int destWidth = (int) (im.getWidth() + scale);
		int destHeight = (int) (im.getHeight() + scale);
